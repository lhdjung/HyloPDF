...
const paths: Record<string, string> = {
  ...
  // A page at its own size: a rectangle with a 1:1 mark in it would be too
  ...
  // A window frame with its own title bar — not the two overlapping
  // rectangles of `copy`, which this used to reuse and which reads as
  // "duplicate" rather than "another window".
  window:
    '<rect x="3.5" y="4.5" width="17" height="15" rx="2"/><path d="M3.5 9.2h17"/>',
